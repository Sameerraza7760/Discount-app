...
<div className='i-container' style={{width:'2%' ,cursor:'pointer'}}><FontAwesomeIcon  style={{color:'green',height:'30px'}} icon={faShoppingCart} onClick={()=>navigate("/userCart")} /></div>
</div>
